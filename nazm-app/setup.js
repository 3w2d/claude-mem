...
function updateNazmFullSystem() {
  ...
  const importStatements = `import { HomeDashboard } from './components/HomeDashboard';
import { AIChat } from './components/AIChat';
import { ResponsiveLayout, MobileContainer } from './components/ResponsiveLayout';
import { usePersist, useTasks, useChatHistory, useStats } from './hooks/usePersistence';
import { useElectronAPI, useAppInfo } from './hooks/useElectron';
`;
  ...
  return <HomeDashboard T={T} isRtl={isRtl} />;
}`
    );
...
╔═══════════════════════════════════════════╗
║   NAZM Project Setup & Organization      ║
║   نَظْم · Intelligence Hub                ║
╚═══════════════════════════════════════════╝
${colors.reset}`);
